 ...
 *
 * Возможности:
 * - Рабочая область фиксированного размера (по умолчанию 1920×1080), автоматическое масштабирование и поля
 ...
 * - Поддержка печати в PDF (Cmd+P / Ctrl+P, один слайд на страницу)
